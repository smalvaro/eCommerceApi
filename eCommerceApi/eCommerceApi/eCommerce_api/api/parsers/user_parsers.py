...
add_user_parser.add_argument('name', type=str, required=True, help='User name')
add_user_parser.add_argument('password', type=str, required=True, help='User password')